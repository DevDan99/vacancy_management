...
public class SecurityFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain filterChain) throws ServletException, IOException {
		 ...
		 */
		if (header == null) {
			var subjectToken = this.jwtProvider.validateToken(header); // Valida o token (isso deve ser implementado no JWTProvider)
			...
			request.setAttribute("companyId", subjectToken); // Adiciona o ID da empresa como um atributo na requisição
